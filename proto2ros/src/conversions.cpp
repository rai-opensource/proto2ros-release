...
void Convert(const builtin_interfaces::msg::Duration &ros_msg,
  ...
  if (ros_msg.nanosec >
    ...
    throw std::range_error(
        "builtin_interfaces/Duration does not fit in google.protobuf.Duration");
  }
...
void Convert(const google::protobuf::Duration &proto_msg,
  ...
  if (proto_msg.seconds() >
      static_cast<google::protobuf::int64>(std::numeric_limits<int>::max())) {
    throw std::range_error(
        "google.protobuf.Durationdoes not fit in builtin_interfaces/Duration");
  }
...
void Convert(const builtin_interfaces::msg::Time &ros_msg,
  ...
  if (ros_msg.nanosec >
      static_cast<unsigned int>(std::numeric_limits<int>::max())) {
    throw std::range_error(
        "builtin_interfaces/Time does not fit in google.protobuf.Timestamp");
  }
  proto_msg->set_nanos(static_cast<int>(ros_msg.nanosec));
}
...
void Convert(const google::protobuf::Timestamp &proto_msg,
  ...
  if (proto_msg.seconds() >
      static_cast<google::protobuf::int64>(std::numeric_limits<int>::max())) {
    throw std::range_error(
        "google.protobuf.Timestamp does not fit in builtin_interfaces/Time");
  }
  ros_msg->sec = static_cast<int>(proto_msg.seconds());
  ros_msg->nanosec = proto_msg.nanos();
}
...
void Convert(const proto2ros::msg::Value &ros_msg,
  ...
  case proto2ros::msg::Value::STRUCT_VALUE_SET: {
    if (ros_msg.struct_value.type_name != "proto2ros/Struct") {
      std::ostringstream message{
          "expected proto2ros/Struct message for struct_value member"};
  ...
  case proto2ros::msg::Value::LIST_VALUE_SET: {
    if (ros_msg.list_value.type_name != "proto2ros/List") {
      std::ostringstream message{
          "expected proto2ros/Struct message for list_value member"};
